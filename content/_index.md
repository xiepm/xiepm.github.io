...
sections:
  ...
  - kicker: "精选内容"
    ...
    gallery:
      - tag: "Visual"
        title: "页面片段"
        summary: "把首页做得更像可以容纳图片和氛围的入口，而不只是文字目录。"
        url: "/projects/design-overview/"
        image: "/images/yinhun8.jpg"
      - tag: "Notes"
        title: "学习剪影"
        summary: "保留轻盈留白，也让图片能自然地穿插在页面中。"
        url: "/study/"
        image: "/images/yinghun9.jpg"
      - tag: "Projects"
        title: "项目印象"
        summary: "后续这里也可以替换成你自己的项目截图、实验照片或作品封面。"
        url: "/projects/"
        image: "/images/girl1.jpg"
      - tag: "About"
        title: "个人站入口"
        summary: "让首页多一些视觉停留点，整体会比纯文本门户更轻松。"
        url: "/about/"
        image: "/images/xing1.jpg"
  - kicker: "知识区"
